...
Applications that already use an Effect HTTP router can compose the proxy with their existing HttpApi layer instead. See [Compose with an Effect API](/docs/proxy#compose-with-an-effect-api).
