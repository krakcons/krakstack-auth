...
Le schéma valide la forme de la recherche; `safeReturnPath` impose la frontière de sécurité. Ne transmettez jamais une URL absolue ou relative au protocole non approuvée à `<Navigate href>`.
