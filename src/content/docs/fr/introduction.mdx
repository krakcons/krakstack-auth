...
> Krakstack Auth est actuellement un logiciel exclusivement auto-hébergé. `auth.krakstack.net` héberge cette documentation et l'instance du mainteneur; il ne s'agit pas d'un service d'authentification géré pour plusieurs clients. Déployez l'image GHCR publiée avec votre propre base PostgreSQL.
