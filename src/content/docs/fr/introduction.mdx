...
slug: introduction
path: /docs
title: Documentation Krakstack Auth
...
| --------------------------------------------- | ------------------------------------------------------------------------------ |
| Connecter une application Web interne         | [Démarrage rapide](/docs/quickstart)                                           |
| Choisir proxy, OAuth ou un hôte personnalisé  | [Méthodes de configuration](/docs/setup)                                       |
| Comprendre les identités et frontières        | [Architecture](/docs/architecture)                                             |
| Configurer le SDK et le backend               | [Exports du SDK](/docs/sdk) et [middleware API](/docs/middleware)              |
| Gérer projets, organisations, clients et clés | [Administration](/docs/administration)                                         |
| Déployer et exploiter le service              | [Auto-hébergement](/docs/self-hosting) et [configuration](/docs/configuration) |
