...
Les applications qui utilisent déjà un routeur HTTP Effect peuvent composer le proxy avec leur couche HttpApi existante. Consultez [Composer avec une API Effect](/docs/proxy#composer-avec-une-api-effect).
