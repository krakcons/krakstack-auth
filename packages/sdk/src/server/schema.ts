...
export const ServerDomain = Schema.Struct({
  ...
  projectLogo: Schema.optional(Schema.NullOr(Schema.String)),
  organizationId: Schema.NullOr(Schema.String),
  organizationName: Schema.optional(Schema.NullOr(Schema.String)),
  organizationLogo: Schema.optional(Schema.NullOr(Schema.String)),
  ...
  examples: [
    {
      ...
      projectId: "kokobi",
      projectName: "Kokobi",
      projectLogo: "https://example.com/kokobi.svg",
      organizationId: "org_1",
      organizationName: "Institute Example",
      organizationLogo: "https://example.com/institute.svg",
